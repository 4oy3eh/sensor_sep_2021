...
public class visual extends AppCompatActivity {
    ...
    Button btnValues, btnCop, btnLeft, btnRight, btnPlay, btnTest, btnGraph, btnCopCalib, btnSavedata;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (setup.equals("left")) {
            ...
            imgCop = findViewById(R.id.imageCop_r);
            imageFeetOverlay = findViewById(R.id.image_first_r);
            imageSensor1_g = findViewById(R.id.image_1sensor_g_r);
            imageSensor1_y = findViewById(R.id.image_1sensor_y_r);
            imageSensor1_r = findViewById(R.id.image_1sensor_r_r);
            imageSensor2_g = findViewById(R.id.image_2sensor_g_r);
            imageSensor2_y = findViewById(R.id.image_2sensor_y_r);
            imageSensor2_r = findViewById(R.id.image_2sensor_r_r);
            imageSensor3_g = findViewById(R.id.image_3sensor_g_r);
            imageSensor3_y = findViewById(R.id.image_3sensor_y_r);
            imageSensor3_r = findViewById(R.id.image_3sensor_r_r);
            imageSensor4_g = findViewById(R.id.image_4sensor_g_r);
            imageSensor4_y = findViewById(R.id.image_4sensor_y_r);
            imageSensor4_r = findViewById(R.id.image_4sensor_r_r);
            imageSensor5_g = findViewById(R.id.image_5sensor_g_r);
            imageSensor5_y = findViewById(R.id.image_5sensor_y_r);
            imageSensor5_r = findViewById(R.id.image_5sensor_r_r);
            imageSensor6_g = findViewById(R.id.image_6sensor_g_r);
            imageSensor6_y = findViewById(R.id.image_6sensor_y_r);
            imageSensor6_r = findViewById(R.id.image_6sensor_r_r);
        }
                    ...
                    try {
                        ...
                        runOnUiThread(new Runnable() {
                            ...
                            public void run() {
                                if (CheckVisualOn) {
                                    if(isLeft) {
                                        if (cop_sensor3 > cop_sensor4 && (calib_sensor3/5)+cop_sensor4 > cop_sensor3) {
                                        ...
                                        } else if(cop_sensor4 > cop_sensor3 && (calib_sensor4/5)+cop_sensor3 > cop_sensor4) {
                                    ...
                                    if(!isLeft){
                                        if(cop_sensor4 > cop_sensor3 && (calib_sensor4/5)+cop_sensor3 > cop_sensor4) {
                                            imageLeftArrow.setVisibility(View.INVISIBLE);
                                            imageRightArrow.setVisibility(View.VISIBLE);
                                            imageDownArrow.setVisibility(View.INVISIBLE);

                                        } else if (cop_sensor3 > cop_sensor4 && (calib_sensor3/5)+cop_sensor4 > cop_sensor3){
                                            imageLeftArrow.setVisibility(View.VISIBLE);
                                            imageRightArrow.setVisibility(View.INVISIBLE);
                                            imageDownArrow.setVisibility(View.INVISIBLE);
                                        } else{
                            ...
                            if (buf[pos] == stop_byte && pos > 45) {
                                if (buf[pos - 46] == start_byte) {
                                    ...
                                    if (threadIdx == sideSelection) {
                                        ...
                                        tm = (int) (System.currentTimeMillis() - timeOfStart);
                                        if (CheckSavingOn) {
                                            tempData.println(tm + "\t" + sVal[0] + "\t" + sVal[1] + "\t" + sVal[2] + "\t" + sVal[3] + "\t" + sVal[4] + "\t" + sVal[5]);
                                        }
...
//                                            cop_sensor6 = (sensor6 - calib_sensor6);
                                        ...
                                        if (CheckVisualOn) {
                                            ...
                                            xValue = (float) (
                                                    cop_sensor1 / cop_sensorSum * Math.cos(Math.toRadians(alphaDegree)) +
                                                            cop_sensor2 / cop_sensorSum * Math.cos(Math.toRadians(180 - alphaDegree)) +
                                                            Math.cos(Math.toRadians(alphaDegree)) * cop_sensor3 / cop_sensorSum * Math.cos(Math.toRadians(0)) +
                                                            Math.cos(Math.toRadians(alphaDegree)) * cop_sensor4 / cop_sensorSum * Math.cos(Math.toRadians(180)) +
                                                            cop_sensor5 / cop_sensorSum * Math.cos(Math.toRadians(360 - alphaDegree)) +
                                                            cop_sensor6 / cop_sensorSum * Math.cos(Math.toRadians(180 + alphaDegree)));
                                            ...
                                            yValue = (float) (
                                                    cop_sensor1 / cop_sensorSum * Math.sin(Math.toRadians(alphaDegree)) +
                                                            ...
                                                            cop_sensor6 / cop_sensorSum * Math.sin(Math.toRadians(180 + alphaDegree)));
