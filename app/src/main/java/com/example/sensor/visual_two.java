...
//
//
//public class visual_two extends AppCompatActivity {
//    boolean startWorker, isCalib = false, first_time_canvas = true;
//    Button btnValues, btnCop, btnLeft, btnRight, btnPlay, btnTest, btnGraph, btnCopCalib, btnSavedata, btnBreak;
//    TextView textSensor1_left, textSensor2_left, textSensor3_left, textSensor4_left, textSensor5_left, textSensor6_left;
//    TextView textSensor1_right, textSensor2_right, textSensor3_right, textSensor4_right, textSensor5_right, textSensor6_right;
//
//    ImageView imgCop;
...
//    long timeOfStart;
//    Sensor tmpSensor_left, tmpSensor_right;
//    //save
...
//        setContentView(R.layout.activity_visual_two);
//
...
//        //  4   3       3   4
//        //  6   5       5   6
//            textSensor1_left = findViewById(R.id.textsensor1left);
//            textSensor2_left = findViewById(R.id.textsensor2left);
//            textSensor3_left = findViewById(R.id.textsensor3left);
//            textSensor4_left = findViewById(R.id.textsensor4left);
//            textSensor5_left = findViewById(R.id.textsensor5left);
//            textSensor6_left = findViewById(R.id.textsensor6left);
//
//            textSensor1_right = findViewById(R.id.textsensor2_right);
//            textSensor2_right = findViewById(R.id.textsensor1_right);
//            textSensor3_right = findViewById(R.id.textsensor4_right);
//            textSensor4_right = findViewById(R.id.textsensor3_right);
//            textSensor5_right = findViewById(R.id.textsensor6_right);
//            textSensor6_right = findViewById(R.id.textsensor5_right);
//
//
//
//        //buttons
...
//        nextIntent = new Intent(this, visual_two.class);
...
//
//        if (ActivityCompat.shouldShowRequestPermissionRationale(visual_two.this, Manifest.permission.WRITE_EXTERNAL_STORAGE)) {
//            Toast.makeText(visual_two.this, "Write External Storage permission allows us to do store images. Please allow this permission in App Settings.", Toast.LENGTH_LONG).show();
//        } else {
//            ActivityCompat.requestPermissions(visual_two.this, new String[]{Manifest.permission.WRITE_EXTERNAL_STORAGE}, 1);
//        }
//    }
//
//    @Override
